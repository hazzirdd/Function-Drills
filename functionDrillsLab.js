...
// arrow
// declaration
let expression = "Answer to problem 7"
...
// arrow
let declaration = "answer to problem 9"
// expression
...
let Newemail = email.trim()
  if (email.includes('@')) {
    console.log(`${Newemail} verified`);
  } else {console.log(`must provide a valid email address`)}
}
// emailCheck(' bobby@gmail.com     ');
